...
INSERT INTO `eventos` (`id`, `nombre`, `descripcion`, `disponibles`, `categoria_id`, `dia_id`, `hora_id`, `ponente_id`) VALUES
(3, 'Tailwind y Figma', 'Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec sodales condimentum magna fringilla egestas. In non pellentesque magna, at mollis velit. Morbi nec dapibus diam. Phasellus ante neque, blandit eget tortor a, cursus molestie turpis. Aenean placerat aliquet nibh, et interdum ipsum finibus at. Nulla sit amet faucibus leo, vel blandit urna. Curabitur dictum euismod sem, eget euismod magna pulvinar et. Nam semper aliquet nunc eu ornare. ', 36, 1, 1, 2, 3);
INSERT INTO `eventos` (`id`, `nombre`, `descripcion`, `disponibles`, `categoria_id`, `dia_id`, `hora_id`, `ponente_id`) VALUES
(4, 'MERN - MongoDB Express React y Node.js - Ejemplo Real', 'Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec sodales condimentum magna fringilla egestas. In non pellentesque magna, at mollis velit. Morbi nec dapibus diam. Phasellus ante neque, blandit eget tortor a, cursus molestie turpis. Aenean placerat aliquet nibh, et interdum ipsum finibus at. Nulla sit amet faucibus leo, vel blandit urna. Curabitur dictum euismod sem, eget euismod magna pulvinar et. Nam semper aliquet nunc eu ornare. ', 35, 1, 2, 4, 8),
...
(20, 'Laravel y Flutter - Creando Un Proyecto Real', 'Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec sodales condimentum magna fringilla egestas. In non pellentesque magna, at mollis velit. Morbi nec dapibus diam. Phasellus ante neque, blandit eget tortor a, cursus molestie turpis. Aenean placerat aliquet nibh, et interdum ipsum finibus at. Nulla sit amet faucibus leo, vel blandit urna. Curabitur dictum euismod sem, eget euismod magna pulvinar et. Nam semper aliquet nunc eu ornare. ', 28, 1, 2, 5, 18),
...
(28, 'React 18 - Una Introducción Práctica', 'Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec sodales condimentum magna fringilla egestas. In non pellentesque magna, at mollis velit. Morbi nec dapibus diam. Phasellus ante neque, blandit eget tortor a, cursus molestie turpis. Aenean placerat aliquet nibh, et interdum ipsum finibus at. Nulla sit amet faucibus leo, vel blandit urna. Curabitur dictum euismod sem, eget euismod magna pulvinar et. Nam semper aliquet nunc eu ornare. ', 27, 1, 1, 6, 9),
(29, 'Vue.js - Composition API', 'Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec sodales condimentum magna fringilla egestas. In non pellentesque magna, at mollis velit. Morbi nec dapibus diam. Phasellus ante neque, blandit eget tortor a, cursus molestie turpis. Aenean placerat aliquet nibh, et interdum ipsum finibus at. Nulla sit amet faucibus leo, vel blandit urna. Curabitur dictum euismod sem, eget euismod magna pulvinar et. Nam semper aliquet nunc eu ornare. ', 14, 1, 1, 7, 14),
...
(18, 'Nicolas', 'Fraga', 'Buenos Aires', 'Argentina', 'e4db26c9a12c187849eab7c82c8db391', 'PHP,Laravel,Flutter,React Native', '{\"facebook\":\"https://facebook.com/C%C3%B3digo-Con-Juan-103341632130628\",\"twitter\":\"https://twitter.com/codigoconjuan\",\"youtube\":\"https://youtube.com/codigoconjuan\",\"instagram\":\"\",\"tiktok\":\"\",\"github\":\"\"}');

INSERT INTO `regalos` (`id`, `nombre`) VALUES
(1, 'Paquete Stickers');
INSERT INTO `regalos` (`id`, `nombre`) VALUES
(2, 'Camiseta Mujer - Chica');
INSERT INTO `regalos` (`id`, `nombre`) VALUES
(3, 'Camiseta Mujer - Mediana');
INSERT INTO `regalos` (`id`, `nombre`) VALUES
(4, 'Camiseta Mujer - Grande'),
(5, 'Camiseta Mujer - XL'),
(6, 'Camiseta Hombre - Chica'),
(7, 'Camiseta Hombre - Mediana'),
(8, 'Camiseta Hombre - Grande'),
(9, 'Camiseta Hombre - XL');

INSERT INTO `registros` (`id`, `paquete_id`, `pago_id`, `token`, `regalo_id`, `usuario_id`) VALUES
(2, 3, '', '9d66006c', NULL, 13);
INSERT INTO `registros` (`id`, `paquete_id`, `pago_id`, `token`, `regalo_id`, `usuario_id`) VALUES
(3, 1, '71R80802VS1256831', '03355d0f', 4, 2);
INSERT INTO `registros` (`id`, `paquete_id`, `pago_id`, `token`, `regalo_id`, `usuario_id`) VALUES
(4, 2, '860106582Y630263W', 'f1b810f3', 1, 14);
INSERT INTO `registros` (`id`, `paquete_id`, `pago_id`, `token`, `regalo_id`, `usuario_id`) VALUES
(18, 1, '7DK00983HY217840L', '1a2e6765', 3, 1);

INSERT INTO `usuarios` (`id`, `nombre`, `apellido`, `email`, `password`, `confirmado`, `token`, `admin`) VALUES
(1, ' Matias', 'Raco', 'matiasraco99@gmail.com', '$2y$10$yHTOEERPe/PC/WTs1kQ9IOoA/zAl3YEqdhFc1LqJZB9ym9cJGwmN6', 1, '', 1);
INSERT INTO `usuarios` (`id`, `nombre`, `apellido`, `email`, `password`, `confirmado`, `token`, `admin`) VALUES
(2, ' Candela', 'Rodriguez', 'correo@correo.com', '$2y$10$4ac7Ayp/Rm.gJpmppc345ur.ty5H5Rll1b5kXnz101latd2P769dO', 1, '', 0);
INSERT INTO `usuarios` (`id`, `nombre`, `apellido`, `email`, `password`, `confirmado`, `token`, `admin`) VALUES
(13, ' Joaquin', 'Rodriguez', 'culitorico@gmail.com', '$2y$10$h4s/9z33.RXigqsgEbfETe8AVpSbFMZjNzIUTgc/ogRgiT6/Lmsgu', 1, '', 0);
INSERT INTO `usuarios` (`id`, `nombre`, `apellido`, `email`, `password`, `confirmado`, `token`, `admin`) VALUES
(14, ' Romina', 'Gutierrez', 'correo2@correo.com', '$2y$10$CT7jUk7XnoSdNXlDecy/3.58Eo1DoiyZnkvwmkUFz.xYZh7uwEJK2', 1, '', 0);
