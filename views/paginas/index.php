...
<section class="speakers">
    ...
    <p class="speakers__descripcion">Conoce a nuestros expértos de DevWebcamp</p>
            ...
            <div <?php aos_animacion(); ?> class="speaker">
                ...
                <div class="speaker__informacion">
                    ...
                    <nav class="speaker-sociales">
                        ...
                        <?php if(!empty($redes->faceboock)): ?>            
                            <a class="speaker-sociales__enlace" rel="noopener noreferrer" target="_blank" href="<?php echo $redes->faceboock; ?>">
